...
It is built to find actual skill folders, compare them as installable candidates, and shorten the path from “I need a skill for this” to “here is the one to try.”
